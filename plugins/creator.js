...
let name4 = '@⳹ ❋ཻུ۪۪CREATOR ZIFABOTZ⳹ ❋ཻུ۪۪)'
  ...
  this.send2Button(m.chat, `*Itu nomor ownerku GUA ANJG!!*\n\n*Mau donasi/sewa DLL?.*\n*Di harapkan tidak menelpon/menyepam no owner OTW PIRTEK.*`, name4, 'Menu', '.menu', 'Profile', '.profile', m)
